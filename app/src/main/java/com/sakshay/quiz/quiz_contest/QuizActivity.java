...
public class QuizActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		seconds=(TextView)findViewById(R.id.textView4);
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
					//mp=MediaPlayer.create(getApplicationContext(), R.raw.wronganswer);
					//mp.start();
	...
	protected void getQuestion()
	{
		...
		do {
			qid=(int) Math.floor(Math.random()*50);//random function to generate questions randomly
	...
	protected void startCount() {
		seconds.setText("Seconds Remaining");
		...
		timer=new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
            	pb.setProgress(0);
            	tv3.setText("");
                seconds.setText("Sorry...Time Up!");
                //submit.setClickable(false);
                submit.setText("Move to next");
                getQuestion();
            }
         }.start();
	}
